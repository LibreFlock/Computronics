package org.libreflock.computronics.audio.tts;
...
public class TextToSpeechLoader {
	...
	public boolean preInit() {
		...
		//classLoader.addClassLoaderExclusion("org.libreflock.computronics.audio.tts.");
		...
		try {
			...
			//classLoader.findClass("org.libreflock.computronics.audio.tts.TextToSpeech");
			Class.forName("marytts.MaryInterface");
			Class.forName("marytts.LocalMaryInterface");
			Class.forName("marytts.server.Mary");
			//Class.forName("org.libreflock.computronics.audio.tts.TextToSpeech");
