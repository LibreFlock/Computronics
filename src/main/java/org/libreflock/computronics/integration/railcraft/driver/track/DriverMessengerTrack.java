	...
	public static class OCDriver extends DriverTrack<TrackKitMessenger> {
		...
		public class InternalManagedEnvironment extends NamedManagedEnvironment<TrackKitMessenger> {
			...
			public Object[] setTitle(Context c, Arguments a) {
				tile.setTitle(new StringTextComponent(a.checkString(0)));
			...
			public Object[] setSubtitle(Context c, Arguments a) {
				tile.setSubtitle(new StringTextComponent(a.checkString(0)));
				return new Object[] { true };
			}
		}
		...
		public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments) throws LuaException, InterruptedException {
			switch(method) {
				...
				case 2: {
					...
					tile.setTitle(new StringTextComponent((String) arguments[0]));
					return new Object[] { true };
				}
				case 3: {
					if(arguments.length < 1 || !(arguments[0] instanceof String)) {
					...
					tile.setSubtitle(new StringTextComponent((String) arguments[0]));
					return new Object[] { true };
				}
			}
			return new Object[] {};
