package org.libreflock.computronics.integration.storagedrawers;
...
public class DriverDrawerGroup {
	...
	public static class OCDriver extends DriverSpecificTileEntity<IDrawerGroup> {
		...
		@Override
		public InternalManagedEnvironment createEnvironment(World world, BlockPos pos, Direction side, IDrawerGroup tile) {
